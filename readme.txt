...
(Only the first three scripts/options can be runned on any computer, the option "MEME" and "run all scripts" can only be runned correctly from a HAN account)
