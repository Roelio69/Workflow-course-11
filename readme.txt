...
Run all of the above -> (install MEME to use this option optimal) automatically runs the four modules (Gene Finder, Find Orthologues, Motif Search and MEME) and put all the results in the directory where all the scripts are. 
...
Script selection -> (install MEME to use this option optimal) runs the four modules (Gene Finder, Find Orthologues, Motif Search and MEME) in your prefered way. The output will be located in the same directory as where all the scripts are. 
